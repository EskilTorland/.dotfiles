# Generated by Powerlevel10k configuration wizard on 2026-02-19 at 16:40 CET.
...
() {
  ...
  function prompt_jj() {
    ...
    [[ $is_conflict == true ]] && res+=" ${warning}✘conflict"
    [[ $is_divergent == true ]] && res+=" ${warning}⚑divergent"

    # Description (truncated to 24 chars)
    if [[ -n $description ]]; then
      (( $#description > 24 )) && description="${description[1,21]}..."
      res+=" ${meta}\"${description}\""
    fi

    p10k segment -f 76 -i '◆' -t "$res"
  }
